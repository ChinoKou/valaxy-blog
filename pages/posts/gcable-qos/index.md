...
> 也就是说，本文所有与网络有关操作未特别提及的，都是自动进入代理核心导流，配置文件规则都是正常的，并且只有一条 VLESS 链路可用(可看后文得知)
...
- 本地长时间测试 0 丢包，而且延迟极低（10\~20ms，毕竟三网优化...）
- 在线工具 [ITDOG-ping](https://www.itdog.cn/ping/) 和 [ITDOG-tcping](https://www.itdog.cn/tcping/) 均 0 丢包，延迟也很低，测试结果如下图
<div align="center">
  <img src="./ping.png" alt="多地PING结果" width="90%">
</div>
<div align="center">
  <img src="./tcping.png" alt="多地TCPING结果" width="90%">
</div>
...
- 也可以用NextTrace
<div align="center">
  <img src="./nexttrace.png" alt="路由追踪结果" width="80%">
</div>
...
<div align="center">
  <img src="./cubic.png" alt="未开启 BBR" width="90%">
</div>
...
<div align="center">
  <img src="./bbr.png" alt="已开启 BBR" width="90%">
</div>

再次 Speedtest.net 测速，下行跑到了 **102Mbps**！

<div align="center">
  <img src="./second-test.png" alt="第二次测速结果" width="90%">
</div>
...
<div align="center">
  <img src="./third-test.png" alt="第三次测速结果" width="90%">
</div>
